...
5. run `npx dev-tool samples check-node-versions --artifact-path <artifact path> --node-versions "18,20"` or you can use any other combination of node versions including specifying the full semver for it.
