...
5. run `pnpm exec dev-tool samples check-node-versions --artifact-path <artifact path> --node-versions "20,22"` or you can use any other combination of node versions including specifying the full semver for it.
