...
4. Run `pnpm install` followed by `pnpm run setup` to be able to use the perf framework for track-1 perf tests.

   _`pnpm run setup` installs the dependencies specified in `package.json`_
