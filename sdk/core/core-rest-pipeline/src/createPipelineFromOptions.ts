...
import { __createPipelineFromOptions } from "@typespec/ts-http-runtime/_internal";
...
export function createPipelineFromOptions(options: InternalPipelineOptions): Pipeline {
  return __createPipelineFromOptions(options, {
    policyToAddAfterUserAgentPolicy: setClientRequestIdPolicy(options.telemetryOptions?.clientRequestIdHeaderName),
    policyToAddAfterDefaultRetryPolicy: tracingPolicy({ ...options.userAgentOptions, ...options.loggingOptions }),
  })
}
